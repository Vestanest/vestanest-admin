...
<head>
    ...
    <title>Message Received - VestaNest</title>
    <style>
    ...
    <div class="email-container">
        <div class="header">
            <div class="logo">
                ...
                <div class="type-badge">Message Received</div>
            </div>
        </div>
        <div class="content">
            <div class="greeting">Hello {{ $messageData['name'] ?? 'there' }}! 👋</div>
            <div class="message">
            ...
            <div class="panel">
                ...
                <div style="margin-top:12px; color:#374151;">Message:<br>{{ $messageData['message'] ?? '' }}</div>
            </div>
            <div class="support">
                <h3>Need Help? 🤝</h3>
                <p>Feel free to reply to this email to add more details.</p>
