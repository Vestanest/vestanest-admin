...
<head>
    ...
    <title>Inquiry Received - VestaNest</title>
    <style>
    ...
    <div class="email-container">
        <div class="header">
            <div class="logo">
                ...
                <div class="type-badge">Inquiry Received</div>
            </div>
        </div>
        <div class="content">
            <div class="greeting">Hello {{ $inquiry['name'] ?? 'there' }}! 👋</div>
            <div class="message">
                Thanks for reaching out about <strong>{{ $inquiry['property']['title'] ?? 'the property' }}</strong>.
                Our team will contact you shortly. Here are your submitted details:
            </div>
            <div class="panel">
                ...
                <div style="margin-top:12px; color:#374151;">Message:<br>{{ $inquiry['message'] ?? '' }}</div>
            </div>
            <div class="support">
                <h3>Need Help? 🤝</h3>
                <p>If you have additional details to share, just reply to this email.</p>
