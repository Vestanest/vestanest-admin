...
<head>
    ...
    <title>Agent Contact Sent - VestaNest</title>
    <style>
    ...
    <div class="email-container">
        <div class="header">
            <div class="logo">
                ...
                <div class="type-badge">Message Sent to Agent</div>
            </div>
        </div>
        <div class="content">
            <div class="greeting">Hello {{ $contact['full_name'] ?? 'there' }}! 👋</div>
            <div class="message">
                We’ve sent your message to the listing agent. They’ll contact you soon.
            </div>
            <div class="panel">
                ...
                <div style="margin-top:12px; color:#374151;">Message:<br>{{ $contact['message'] ?? '' }}</div>
            </div>
            <div class="support">
                <h3>Need Help? 🤝</h3>
                <p>Reply to this email if you wish to add more details.</p>
